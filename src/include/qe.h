...
#define QE_EOF (-1)  // end of the index scan
    ...
    public:
        ...
        vector<Attribute> attribute;
        void* data;
        vector<Attribute> beforeAttribute;
        vector<string> attributeNames;
        Iterator *iterator;
        map<string, int>beforeAttributePositionMap;
    };
    ...
    public:
        ...
        map <string, vector<void*>> bufferMap;
        bool readLeft=true;
        int leftReturnVal=0;
        int mapVecPos=0;
    };
